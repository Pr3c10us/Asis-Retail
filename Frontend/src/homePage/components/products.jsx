...
const Products = ({
  ...
  return (
    <motion.div
      ...
      className="relative aspect-[9/16] h-[312px] w-[239px] cursor-pointer max-sm:h-[235px] max-sm:w-[11rem]"
    >
      ...
      <div className="absolute bottom-5 left-5 mt-2 font-semibold lowercase">
        <p className="text-xs font-semibold uppercase text-[#ffff]">
